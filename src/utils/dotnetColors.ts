...
/**
 * Convert a .NET named color string (e.g. "Color.Green" or "Green") to an RGBA value.
 * The lookup is case-insensitive and the "Color." prefix is optional.
 */
export function dotnetColorToRGBA(colorStr: string): RGBA | undefined {
  let name = colorStr.trim()
  const dotIndex = name.indexOf('.')
  if (dotIndex !== -1) {
    name = name.substring(dotIndex + 1)
  }
  return dotnetColors[name.toLowerCase()]
}
